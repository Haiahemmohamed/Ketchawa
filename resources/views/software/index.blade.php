                        ...
                        <div class="tab-content">
                            <div class="tab-pane show active" id="home-b2">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-lg-6">
                                        <a class="btn btn-success btn-rounded float-right" href="{{ route('softwares.create') }}"><i class="fas fas fa-plus-circle"></i></a>
                                    </div>
                                </div>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        @foreach ($softwares as $index => $software)
                                            <tr class="text-center">
                                                ...
                                                <td>{{ $software->d_purchase }}</td>
                                                <td>{{ $software->acquisition_d }}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('software.destroy', $software->id) }}" method="POST">
                                                        ...
                                                        <a class="btn btn-info" href="{{ route('software.show', $software->id) }}"><i class="fas fas fa-eye"></i></a>
                                                        <a class="btn btn-primary"
                                                            href="{{ route('software.edit', $software->id) }}"><i class="fas fas fa-edit"></i></a>
